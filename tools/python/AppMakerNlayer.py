...
#app_nameBGCReactionsType.F90
    ...
    ff90.write("    procedure :: reset_biostates\n")
    ff90.write("    procedure :: SetParCols\n")
    ...
    ff90.write("!----------------------------------------------------------------------\n")
    ff90.write("  subroutine set_kinetics_par(this, lbj, ubj, nactpft, plantNutkinetics, tracers, tracercoeff_vars)\n")
    ff90.write("  !\n")
    ff90.write("  !DESCRIPTION\n")
    ...
    ff90.write("  type(betrtracer_type)       , intent(in) :: tracers\n")
    ...
    ff90.write("  use TracerCoeffType         , only : tracercoeff_type\n")
    ff90.write("  use BeTR_TimeMod            , only : betr_time_type\n")
    ff90.write("  implicit none\n")
    ff90.write("  ! !ARGUMENTS:\n")
    ff90.write("  class("+app_name+"_bgc_reaction_type) , intent(inout)    :: this        !\n")
    ff90.write("  type(bounds_type)                 , intent(in)    :: bounds             !\n")
    ...
    ff90.write("  type(betr_time_type)              , intent(in)    :: betr_time\n")
    ...
    ff90.write("    num_soilp,filter_soilp, jtops, betr_time, betrtracer_vars, tracercoeff_vars,  biophysforc, &\n")
    ...
    ff90.write("  integer                           , intent(in)    :: lbj, ubj    ! lower and upper bounds, make sure they are > 0\n")
    ff90.write("  type(betr_time_type)              , intent(in)    :: betr_time                       ! model time step\n")
    ...
    ff90.write("      !do bgc reaction\n")
    ff90.write("      call this%"+app_name+"_bgc(c,j)%runbgc(is_surflit, betr_time%delta_time, this%"+app_name+"_forc(c,j), nstates, ystates0, ystatesf, betr_status)\n")
    ...
    ff90.write("      endif\n")
    ff90.write("\n")
    ff90.write("      call this%retrieve_output(c, j, nstates, ystates0, ystatesf, betr_time%delta_time, betrtracer_vars, tracerflux_vars,&\n")
    ...
    ff90.write("  !----------------------------------------------------------------------\n")
    ff90.write("  subroutine reset_biostates(this, bounds, lbj, ubj, jtops, num_soilc, filter_soilc, &\n")
    ff90.write("    betrtracer_vars, biophysforc,  tracerstate_vars, betr_status)\n")
    ...
    ff90.write("     type(betr_status_type)           , intent(out)   :: betr_status\n")
    ff90.write("  \n")
    ff90.write("  end subroutine reset_biostates\n")
    ff90.write("  \n")
    ff90.write("  !----------------------------------------------------------------------\n")
    ff90.write("  subroutine SetParCols(this, parcol)\n")
    ff90.write("   implicit none\n")
    ff90.write("  class("+app_name+"_bgc_reaction_type) , intent(inout) :: this      !\n")
    ff90.write("    integer, intent(in) :: parcol\n")
    ff90.write("\n")
    ff90.write("    this%parcol = parcol\n")
    ff90.write("  end subroutine SetParCols\n")
    ff90.write("\n")
