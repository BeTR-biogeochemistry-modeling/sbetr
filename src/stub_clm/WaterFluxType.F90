module WaterfluxType
  ...
  type, public :: waterflux_type
    ...
    real(r8), pointer :: qflx_runoff_tot_col      (:) => null()  !total runoff of the given column, mm/s
  contains
    procedure          :: Init
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%qflx_runoff_tot_col      (begc:endc))              ; this%qflx_runoff_tot_col      (:) = nan
