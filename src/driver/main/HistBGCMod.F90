...
contains
  ...
  if(index(trim(reaction_method),'ecacnp')/=0)then
    ...
    call list_insert(hist_list_var,'som1p',id1, itype=var_state_type)     ; call list_insert(hist_list_unit,'gN m-2',id2)
    call list_insert(hist_list_var,'som2p',id1, itype=var_state_type)     ; call list_insert(hist_list_unit,'gN m-2',id2)
    call list_insert(hist_list_var,'som3p',id1, itype=var_state_type)     ; call list_insert(hist_list_unit,'gN m-2',id2)
    this%nhistvars=id1
