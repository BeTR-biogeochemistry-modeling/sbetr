module tracer1beckPlantSoilBGCType
  !
  !DESCRIPTION
  ! tracer1beck interface for plant soil bgc coupling
#include "bshr_assert.h"
  ...
  character(len=*), private, parameter :: mod_filename = &
       __FILE__
  public :: plant_soilbgc_tracer1beck_run_type

  type, extends(plant_soilbgc_type) :: &
    plant_soilbgc_tracer1beck_run_type
  private
    contains
  ...
  end type plant_soilbgc_tracer1beck_run_type

  interface plant_soilbgc_tracer1beck_run_type
    module procedure constructor
  end interface plant_soilbgc_tracer1beck_run_type

  contains

  !-------------------------------------------------------------------------------
  type(plant_soilbgc_tracer1beck_run_type) function constructor()
  !
  ! !DESCRIPTION:
  ! create an object of type plant_soilbgc_tracer1beck_run_type.
  ! Right now it is purposely empty
    type(plant_soilbgc_tracer1beck_run_type), allocatable :: plants
    allocate(plants)
    constructor = plants
  ...
  implicit none
  ! !ARGUMENTS:
  class(plant_soilbgc_tracer1beck_run_type) , intent(inout) :: this
...
end module tracer1beckPlantSoilBGCType
