...
implicit none
 ...
 ! !LOCAL VARIABLES:
  ...
  !---------------------------------------------------------------------------------
  subroutine calc_cascade_matrix(this, ch4lake_bgc_index, n2_n2o_ratio_denit, cascade_matrix)
  ...
  associate(                                                &
    primvarid    => ch4lake_bgc_index%primvarid            , & !
    ...
    lid_nh4_nit        => ch4lake_bgc_index%lid_nh4_nit    , & !
    lid_n2o_nit=> ch4lake_bgc_index%lid_n2o_nit              & !
  ...
  !---------------------------------------------------------------------------------
  subroutine run_nitden(this, ch4lake_bgc_index,bgc_forc, decompkf_eca,&
  ...
  call this%calc_cascade_matrix(ch4lake_bgc_index, n2_n2o_ratio_denit, cascade_matrix)
  end subroutine run_nitden

end module ch4lakeBGCNitDenType
