...
implicit none
  ...
  type, public :: Compet_CH4LAKE_type
...
contains
  ...
  implicit none
  class(Compet_CH4LAKE_type), intent(inout) :: this
...
end module ch4lakeBGCCompetType
