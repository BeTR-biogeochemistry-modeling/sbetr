...
implicit none
 ...
 type, public, extends(BiogeoCon_type) :: ch4lake_para_type
 ...
 end type ch4lake_para_type

 type(ch4lake_para_type), public :: ch4lake_para
 public :: create_jarpars_ch4lake
contains

  function create_jarpars_ch4lake()
  ! DESCRIPTION
  ! constructor
    implicit none
    class(ch4lake_para_type), pointer :: create_jarpars_ch4lake
    class(ch4lake_para_type), pointer :: bgc

    allocate(bgc)
    create_jarpars_ch4lake => bgc

  end function create_jarpars_ch4lake
  ...
  implicit none
  class(ch4lake_para_type), intent(inout) :: this
