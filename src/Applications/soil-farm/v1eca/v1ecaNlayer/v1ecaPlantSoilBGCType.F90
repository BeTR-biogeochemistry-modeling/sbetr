...
#include "bshr_assert.h"
  ...
  character(len=*), private, parameter :: filename = &
       __FILE__
  public :: v1eca_plant_soilbgc_type
  ...
  end type v1eca_plant_soilbgc_type

  interface v1eca_plant_soilbgc_type
    module procedure constructor
  end interface v1eca_plant_soilbgc_type

  contains

  !-------------------------------------------------------------------------------
  type(v1eca_plant_soilbgc_type) function constructor()
  !
  ! !DESCRIPTION:
  ! create an object of type v1eca_plant_soilbgc_type.
  ! Right now it is purposely empty
   type(v1eca_plant_soilbgc_type), allocatable :: plants
   allocate(plants)
   constructor = plants
  ...
  implicit none
  ! !ARGUMENTS:
  class(v1eca_plant_soilbgc_type) , intent(inout) :: this
  ...
  !----------------------------------------------------------------------
end module v1ecaPlantSoilBGCType
