...
implicit none
 ...
 ! !LOCAL VARIABLES:
  ...
  !---------------------------------------------------------------------------------
  subroutine calc_cascade_matrix(this, v1eca_bgc_index, n2_n2o_ratio_denit, cascade_matrix)
  ...
  associate(                                                &
    primvarid    => v1eca_bgc_index%primvarid            , & !
    ...
    lid_n2o_nit=> v1eca_bgc_index%lid_n2o_nit              & !
  ...
  !---------------------------------------------------------------------------------
  subroutine run_nitden(this, v1eca_bgc_index,bgc_forc, decompkf_eca,&
  ...
  call this%calc_cascade_matrix(v1eca_bgc_index, n2_n2o_ratio_denit, cascade_matrix)
  end subroutine run_nitden

end module v1ecaBGCNitDenType
