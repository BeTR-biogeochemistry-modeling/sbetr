...
implicit none
  ...
  end type summseca_forc_type

  public :: create_summseca_forc_type
contains

  function create_summseca_forc_type()
  ! DESCRIPTION
  ! constructor
    implicit none
    class(summseca_forc_type), pointer :: create_summseca_forc_type
    class(summseca_forc_type), pointer :: forc

    allocate(forc)
    create_summseca_forc_type => forc

  end function create_summseca_forc_type
  !--------------------------------------------------------------------
  subroutine Init(this, summsbgc_index)
  ...
  call this%InitAllocate(summsbgc_index)
  ...
  allocate(this%ystates(summsbgc_index%nstvars))
  ...
  !input
  this%cflx_input_litr_met_c13 =1._r8   !g C/m2/s   !1% for now
  this%cflx_input_litr_cel_c13 =.5_r8   !g C/m2/s
  this%cflx_input_litr_lig_c13 =.2_r8   !g C/m2/s
  this%cflx_input_litr_cwd_c13 =1._r8
  this%cflx_input_litr_fwd_c13 =.5_r8
  this%cflx_input_litr_lwd_c13 =.2_r8

  this%nflx_input_litr_met_c13 =.02_r8
  this%nflx_input_litr_cel_c13 =.01_r8
  this%nflx_input_litr_lig_c13 =.004_r8
  this%nflx_input_litr_cwd_c13 =.01_r8
  this%nflx_input_litr_fwd_c13 =.002_r8
  this%nflx_input_litr_lwd_c13 =.001_r8
  ...
  !input
  this%cflx_input_litr_met_c14 =1.e-10_r8   !g C/m2/s
  this%cflx_input_litr_cel_c14 =5.e-11_r8   !g C/m2/s
  this%cflx_input_litr_lig_c14 =2.e-11_r8   !g C/m2/s
  this%cflx_input_litr_cwd_c14 =1.e-10_r8
  this%cflx_input_litr_fwd_c14 =5.e-11_r8
  this%cflx_input_litr_lwd_c14 =2.e-11_r8

  this%nflx_input_litr_met_c14 =2.e-12_r8
  this%nflx_input_litr_cel_c14 =1.e-12_r8
  this%nflx_input_litr_lig_c14 =4.e-13_r8
  this%nflx_input_litr_cwd_c14 =1.e-12_r8
  this%nflx_input_litr_fwd_c14 =2.e-13_r8
  this%nflx_input_litr_lwd_c14 =1.e-13_r8
