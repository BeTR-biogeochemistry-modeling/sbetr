...
#include "bshr_assert.h"
  ...
  character(len=*), private, parameter :: mod_filename = &
    __FILE__
  public :: fake_plant_soilbgc_type

  type, extends(plant_soilbgc_type) :: &
    fake_plant_soilbgc_type
    private
  contains
  ...
  end type fake_plant_soilbgc_type

  interface fake_plant_soilbgc_type
    module procedure constructor
  end interface fake_plant_soilbgc_type

  contains
!-------------------------------------------------------------------------------
  type(fake_plant_soilbgc_type) function constructor()
  !
  ! !DESCRIPTION:
  ! create an object of type fake_plant_soilbgc_type.
  ! Right now it is purposely empty
  type(fake_plant_soilbgc_type), allocatable :: plants
  allocate(plants)
  constructor = plants
...
!-------------------------------------------------------------------------------
  ...
  implicit none
  ! !ARGUMENTS:
  class(fake_plant_soilbgc_type) , intent(inout) :: this
...
end module fakePlantSoilBGCType
