...
implicit none
  ...
  type, public :: Compet_CH4SOIL_type
...
contains
  ...
  implicit none
  class(Compet_CH4SOIL_type), intent(inout) :: this
...
end module ch4soilBGCCompetType
