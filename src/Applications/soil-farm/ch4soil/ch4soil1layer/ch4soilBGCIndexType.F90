...
implicit none
  ...
  type, public, extends(gbgc_index_type) :: ch4soil_bgc_index_type
  ...
  end type ch4soil_bgc_index_type
  ...
  subroutine Init(this, use_c13, use_c14, non_limit, nop_limit, maxpft, batch_mode)
    !
    ! DESCRIPTION:
    ! Initialize ch4soil_bgc type
    ! !USES:
  implicit none
  ! !ARGUMENTS:
  class(ch4soil_bgc_index_type), intent(inout) :: this
  ...
  subroutine InitPars(this, maxpft, use_c14, use_c13, non_limit, nop_limit, batch_mode)
    ...
    implicit none
    class(ch4soil_bgc_index_type) :: this
...
end module ch4soilBGCIndexType
