...
contains
  ...
  if(betr_spinup_state/=0)then
    move_scalar(tracers%id_trc_Bm)  = ch4soil_para%spinup_factor(7)
    move_scalar(tracers%id_trc_som) = ch4soil_para%spinup_factor(8)*latacc
    move_scalar(tracers%id_trc_pom)=ch4soil_para%spinup_factor(9)  *latacc
  endif
