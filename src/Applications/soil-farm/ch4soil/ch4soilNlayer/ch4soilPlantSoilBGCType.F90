module ch4soilPlantSoilBGCType
...
#include "bshr_assert.h"
  ...
  character(len=*), private, parameter :: filename = &
       __FILE__
  public :: ch4soil_plant_soilbgc_type

  type, extends(plant_soilbgc_type) :: &
    ch4soil_plant_soilbgc_type
  ...
  end type ch4soil_plant_soilbgc_type

  interface ch4soil_plant_soilbgc_type
    module procedure constructor
  end interface ch4soil_plant_soilbgc_type

  contains

  !-------------------------------------------------------------------------------
  type(ch4soil_plant_soilbgc_type) function constructor()
  !
  ! !DESCRIPTION:
  ! create an object of type ch4soil_plant_soilbgc_type.
  ! Right now it is purposely empty
   type(ch4soil_plant_soilbgc_type), allocatable :: plants
   allocate(plants)
   constructor = plants
...
!  if(betrtracer_vars%debug)print*,'pft wcoltot',pft%npfts,sum(pft%wtcol(1:pft%npfts))
  ...
  !----------------------------------------------------------------------
end module ch4soilPlantSoilBGCType
