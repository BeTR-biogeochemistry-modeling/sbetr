...
#include "shr_assert.h"
  ...
  use betr_varcon         , only : bspval => spval
  use clm_varcon         , only : catomw, natomw, patomw
  use clm_varpar         , only : ndecomp_pools
  use betr_ColumnType         , only : col
  use betr_PatchType          , only : pft
...
contains
  ...
  subroutine calc_anaerobic_frac(bounds, lbj, ubj, numf, filter, jtops, t_soisno, soilstate_vars, &
    ...
    use SoilStatetype       , only : soilstate_type
    use BGCCentECACNPParMod    , only : CNNitrifDenitrifParamsInst
