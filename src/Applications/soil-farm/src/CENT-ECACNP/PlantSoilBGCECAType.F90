module PlantSoilBGCECAType
  ...
  public :: plant_soilbgc_ECA_type

  type, extends(plant_soilbgc_type) :: &
    plant_soilbgc_ECA_type
  private
    contains
    procedure :: Init_plant_soilbgc
    procedure :: plant_soilbgc_summary
    procedure :: integrate_vr_flux_to_2D
  end type plant_soilbgc_ECA_type


  interface plant_soilbgc_ECA_type
    module procedure constructor
  end interface plant_soilbgc_ECA_type

  contains

  !-------------------------------------------------------------------------------
  type(plant_soilbgc_ECA_type) function constructor()
  !
  ! !DESCRIPTION:
  ! create an object of type plant_soilbgc_ECA_type.
  ...
  ! !ARGUMENTS:
  class(plant_soilbgc_ECA_type) , intent(in) :: this
